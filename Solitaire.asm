...
IsInInstDlgBtn  lda VIC+16
                ...
                sta res
                rts
not_in_instbtn  lda #0
                sta res
                rts

IsInAboutDlgBtn lda VIC+16
                and #%00000001
                bne not_in_tmcbtn
                lda VIC
                cmp #224
